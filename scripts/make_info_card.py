...
# ===========================================================================
HOST = "jeffery"   # shown as  jeffery@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full Stack Developer @ MMIP"),
    ("kv", "Prev", "Software Engineer"),
    ...
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Developing scalable web systems at MMIP"),
    ("bul", "Designing modern and interactive UIs"),
]
